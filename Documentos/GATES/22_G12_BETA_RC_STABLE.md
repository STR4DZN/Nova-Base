...
Especificar em nível executável tudo que deve ser feito no G12, como o código deve ficar ao terminar e qual condição permite seguir ao gate seguinte.
...
- feature creep em RC
- publishar ZIP não testado
- prometer compatibility não testada
...
|---|---|---|
| G12.1 | Alpha package | controlled testing |
| G12.2 | Beta scope freeze | core flows complete |
| G12.3 | Compatibility matrix | Foundry/dependencies actually tested |
| G12.4 | Upgrade/migration rehearsal | supported old versions |
| G12.5 | Support/diagnostic bundle | sanitized report |
| G12.6 | RC1 | feature freeze |
| G12.7 | RC fixes only | blockers/regressions |
| G12.8 | Final install/upgrade/restore | artifact itself tested |
| G12.9 | Release notes/changelog/rollback | operator-ready |
| G12.10 | Stable sign-off | all stable blockers zero |
...
- [ ] sem data-loss blocker
- [ ] sem secret leakage
- [ ] sem authority bypass
- [ ] migrations críticas ensaiadas
- [ ] ZIP final instalado/testado
- [ ] upgrade suportado testado
- [ ] recovery path claro
- [ ] diagnostic report funciona
- [ ] performance/multiplayer smoke pass
